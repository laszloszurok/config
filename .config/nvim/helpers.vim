...
" Function to handle deletition of buffers. Keeps the window of a deleted buffer
" open and replaces it with the previous buffer if there is one, leaves an empty
" buffer otherwise
