...
static Key keys[] = {
    ...
    { 0,                       XF86XK_MonBrightnessUp,     spawn,          SHCMD("xbacklight -inc 1 ; pkill -RTMIN+11 dwmblocks") },
    { 0,                       XF86XK_MonBrightnessDown,   spawn,          SHCMD("xbacklight -dec 1 ; pkill -RTMIN+11 dwmblocks") },
